...
namespace Drupal\migrate_shopify\Plugin\migrate\source;

use Drupal\migrate_shopify\DemoCsv;
 ...
 *
 * @MigrateSource(
 *   id = "migrate_shopify_product_csv"
 * )
 */
class ShopifyProduct extends CSV {
